                        ...
                        <form class="user" method="post" action="{{ route('profile.update') }}">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    <input type="text" name="name" class="form-control form-control-user @error('name') is-invalid @enderror" id="exampleFirstName" placeholder="Name" value="{{ old('name', $user->name) }}">
                                    @error('name')
                            ...
                            <div class="form-group">
                                <input readonly type="email" class="form-control form-control-user @error('email') is-invalid @enderror" id="exampleInputEmail" placeholder="Email Address" value="{{ $user->email }}">
                                @error('email')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
