                        ...
                        <form class="user" method="post" action="{{ route('register.attempt') }}">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-12 mb-3 mb-sm-0">
                                    <input type="text" name="name" class="form-control form-control-user @error('name') is-invalid @enderror" id="exampleFirstName" placeholder="Name" value="{{ old('name') }}">
                                    @error('name')
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox small">
                                    <input name="is_admin" value="1" type="checkbox" class="custom-control-input" id="customCheck">
